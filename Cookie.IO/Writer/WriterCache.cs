...
namespace Cookie.IO.Writer
{
    ...
    internal static unsafe class WriterCache
    {
        static WriterCache()
        {
            ...
            WriterCache<bool>.SingleWriteValue =
                (dst, value) => WriterCache<byte>.SingleWriteValue(dst, value ? (byte) 1 : (byte) 0);
            ...
            WriterCache<float>.SingleWriteValue =
                (dst, value) => BigEndian.WriteInt32(dst, Reinterpret.FloatAsInt32(value));
            WriterCache<double>.SingleWriteValue =
                (dst, value) => BigEndian.WriteInt64(dst, Reinterpret.DoubleAsInt64(value));
