...
namespace Cookie.IO.Writer
{
    public unsafe class WriterContext : IWriter
    {
        ...
        public void WriteWrappedBool<T>(T value, int offset = 0, bool forceNewByte = false)
        {
            ...
            _bw.CurrentWrappedBooleanByte =
                WriterCache<T>.SingleWrapBoolean(value, _bw.CurrentWrappedBooleanByte, _bw.CurrentWrappedBooleanOffset);
        ...
        {
            _bw.Position = (int) CurrentPtr - (int) _startPtr;
        }
    }
}