...
namespace Cookie.IO.Reader
{
    public unsafe class ReaderContext : IReader
    {
        ...
        internal void UpdatePosition() => _br.Position = Position;
        ...
        public T ReadWrappedBool<T>(int offset, bool forceNewByte)
        {
            ...
            var r = ReaderCache<T>.SingleReadWrappedBool(_br.CurrentWrappedBooleanByte, _br.CurrentWrappedBooleanOffset);
