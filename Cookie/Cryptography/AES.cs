...
//        private static string _gameTicket;
...
//        {
//            var dr = new FastBinaryReader(new byte[32]);
...
//            aesAlg.IV = dr.ReadArray<byte>(16);
...
//                    _gameTicket = System.Text.Encoding.UTF8.GetString(ms.ToArray());
//                    ms.Dispose();
//                }
//            }
//            return _gameTicket;
