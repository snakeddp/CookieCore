...
namespace Cookie.Cryptography
{
    public class Rsa
    {
        internal const string MPublicKey =
        ...
        public static byte[] Encrypt(byte[] helloConnectMessageKey, string accountName, string accountPassword,
            string salt)
        {
            ...
            var numArray2 = new byte[numArray1.Length];
